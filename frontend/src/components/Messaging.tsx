...
const Messaging: React.FC<Props> = ({ request, onBack }) => {
  ...
  return (
    <Container>
      ...
      <Typography variant="h5" mt={2}>Conversation</Typography>
      <List>
        {messages.map(msg => (
      ...
      <TextField fullWidth placeholder="Type message" value={text} onChange={e => setText(e.target.value)} sx={{ mt: 2 }} />
